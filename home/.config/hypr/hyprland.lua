...
hl.env("GDK_SCALE", tostring(DISPLAY_SCALE))
hl.env("HYPRCURSOR_SIZE", tostring(math.floor(16 * DISPLAY_SCALE)))
hl.env("XCURSOR_SIZE", tostring(math.floor(16 * DISPLAY_SCALE)))

hl.env("HYPRCURSOR_THEME", CURSOR_THEME)
hl.env("XCURSOR_THEME", CURSOR_THEME)

-- To communicate with ssh-agent.service
local SSH_AUTH_SOCK = os.getenv("XDG_RUNTIME_DIR") .. "/ssh-agent.socket"
...
local symbol_picker = "rofi -modes rofimoji:rofimoji -show"
...
hl.on("hyprland.start", function ()
    ...
    hl.exec_cmd("/usr/bin/ssh-agent -a " .. SSH_AUTH_SOCK)
end)
...
hl.bind(mainMod .. " + SHIFT + F", function()
    ...
    hl.dispatch(hl.dsp.exec_cmd(fileManager))
end)
...
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd(app_launcher))
hl.bind(mainMod .. " + S", hl.dsp.exec_cmd(symbol_picker))
